...
const ItemTodoEdit = (props) => {
  ...
  return (
    <div className="ml-2 flex-auto border-b-2 border-neutral-100 border-opacity-50 py-2">
      <form onSubmit={submitHandler} className="flex w-full ">
        ...
        <div className="ml-2 flex-none space-x-2">
          <button
            type="submit"
            className="cursor-pointer rounded border-2 bg-white p-1 hover:border-black"
          >
